...
<body>
    <div class="container">
        <a href="${pageContext.request.contextPath}/management/order-list<%
            String qs = "";
            boolean first = true;
        ...
        <% } else { %>
            <div class="error-message">
                ...
                <a href="${pageContext.request.contextPath}/management/order-list" class="back-btn">Back to Order List</a>
            </div>
        <% } %>
    </div>
</body>
