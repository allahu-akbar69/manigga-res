...
<head>
    <meta charset="UTF-8">
    <title>Danh sách đơn hàng - Quản lý</title>
    <style>
        body {
...
<body>
    <div class="topnav">
        ...
        <div class="navlinks">
            ...
            <a href="dishStatView.jsp">Thống kê</a>
        </div>
    </div>
    <div class="container">
        <a href="/restaurant-management/management/dish-stats<%= (startDate != null || endDate != null) ? ("?" + (startDate != null ? ("startDate=" + startDate) : "") + (startDate != null && endDate != null ? "&" : "") + (endDate != null ? ("endDate=" + endDate) : "")) : "" %>" class="back-btn">Quay lại thống kê món</a>
        
        <div class="header">
            <h1>Đơn hàng của <%= dishName %></h1>
            <p>Danh sách đơn có chứa món đã chọn</p>
        </div>
                ...
                <tbody>
                    <% for (Order order : orders) { %>
                        <tr>
                            ...
                            <td>
                                <a href="/restaurant-management/management/order-detail?orderId=<%= order.getOrderId() %><%= (dishId != null ? ("&dishId=" + dishId) : "") %><%= (startDate != null ? ("&startDate=" + startDate) : "") %><%= (endDate != null ? ("&endDate=" + endDate) : "") %>" class="view-detail-btn">Xem chi tiết</a>
                            </td>
                        </tr>
                    <% } %>
                </tbody>
        ...
        <% } else { %>
            <div class="no-orders">
                <p>Không có đơn nào cho món đã chọn.</p>
            </div>
        <% } %>
    </div>
</body>
