...
<head>
    <meta charset="UTF-8">
    <title>Dish Statistics - Management</title>
    <style>
        body {
...
<body>
    <div class="topnav">
        ...
        <div class="navlinks">
            ...
            <a href="${pageContext.request.contextPath}/management/dish-stats" style="background-color: rgba(255,255,255,0.15);">Statistics</a>
        </div>
    </div>
    <div class="container">
        <a href="${pageContext.request.contextPath}/management/statView.jsp" class="back-btn">Back to Statistics</a>
        
        <div class="header">
            <h1>Dish Statistics</h1>
            <p class="subtitle">Revenue and performance analysis by time period</p>
        </div>
        
        <div class="date-form">
            <form method="get" action="${pageContext.request.contextPath}/management/dish-stats">
                ...
                <tbody>
                    <% int rank = 1; for (DishStat stat : dishStats) { %>
                        <tr>
                            ...
                            <td>
                                <a href="${pageContext.request.contextPath}/management/order-list?dishId=<%= stat.getDishId() %>&startDate=<%= startDate %>&endDate=<%= endDate %>" class="view-orders-btn">View Orders</a>
                            </td>
                        </tr>
                    <% } %>
                </tbody>
